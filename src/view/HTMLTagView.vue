<template>
    <H1TagView v-if="tagdata.tagname == 'h1'" :tagdata="tagdata" draggable="true" @dragstart.stop="on_drag_start"
        @delete_tag="delete_tag" :copied_tagdata="copied_tagdata" :clicked_tagdata="clicked_tagdata" @copy_tag="copy_tag" @click="onclick"
        @updated_tagdatas_root="updated_tagdatas_root" :show_border="show_border" @contextmenu.stop.prevent="show_contextmenu"
    ...
    <DateTimeLocalTagView v-if="tagdata.tagname == 'datetimelocal'" :tagdata="tagdata" draggable="true" @click="onclick"
        @delete_tag="delete_tag" :copied_tagdata="copied_tagdata" :clicked_tagdata="clicked_tagdata" @copy_tag="copy_tag"
        @updated_tagdatas_root="updated_tagdatas_root" :tagdatas_root="tagdatas_root" :show_border="show_border"
        @dragstart.stop="on_drag_start" @contextmenu.stop.prevent="show_contextmenu" @onclick_tag="onclick_tag"
