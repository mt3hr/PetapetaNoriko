<template>
    <ul :style="position_css" @dragover="on_dragover" @click.prevent.stop="onclick_tag(tagdata)" :class="tagclass"
        @contextmenu.prevent.stop="show_contextmenu" :id="tagdata.tagid" @drop="(e) => on_drop(e, tagdata)"
