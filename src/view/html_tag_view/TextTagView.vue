<template>
    <input v-if="label_type == LabelType.None" type="text" dropzone="true" @drop="(e) => on_drop(e, tagdata)"
...
export default class TextTagView extends HTMLTagViewBase {
    ...
    override get tagdata_typed(): TextTagData { return this.tagdata as TextTagData }
