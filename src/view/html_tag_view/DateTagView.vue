<template>
    <input v-if="label_type == LabelType.None" type="date" dropzone="true" @drop="(e) => on_drop(e, tagdata)"
...
export default class DateTagView extends HTMLTagViewBase {
    ...
    override get tagdata_typed(): DateTagData { return this.tagdata as DateTagData }
