<template>
    <input v-if="label_type == LabelType.None" type="search" dropzone="true" @drop="(e) => on_drop(e, tagdata)"
        ...
        :placeholder="placeholder" :class="tagclass" :id="tagdata.tagid" :required="required" :list="list">
