<template>
    <th :style="position_css" dropzone="true" @dragover="on_dragover" @click.prevent.stop="onclick_tag(tagdata)"
...
export default class THTagView extends HTMLTagViewBase {
    ...
    override get tagdata_typed(): THTagData { return this.tagdata as THTagData }
