<template>
    <table :style="position_css" dropzone="true" @dragover="on_dragover" @click.prevent.stop="onclick_tag(tagdata)"
        @contextmenu.prevent.stop="show_contextmenu" :class="tagclass" :id="tagdata.tagid"
        @drop="(e) => on_drop(e, tagdata)" :disabled="disabled" :label="label" :selected="selected" :value="value"
...
export default class TableTagView extends HTMLTagViewBase {
    ...
    override get tagdata_typed(): TableTagData { return this.tagdata as TableTagData }
